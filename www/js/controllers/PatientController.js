 ...
 */
starter.controller('PatientCtrl', function($scope, 
										$state,
										$stateParams, 
										$ionicLoading, 
										$ionicActionSheet,
										...
										$cordovaFileTransfer,
										appService) {
	// permet de stocker la fiche patient pour l'affichage ou l'edition
	$scope.patient = {};
	...
	$scope.saveOrdonnance = function() {
		...
		appService.saveOrdonnance($scope.ordonnance, $scope.patient.token).then(
				// success
				function (response) {
